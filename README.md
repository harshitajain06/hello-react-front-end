...
```sh
  git clone https://github.com/harshitajain06/hello-react-front-end.git
...
Feel free to check the [issues page]( https://github.com/harshitajain06/hello-react-front-end/issues).
...
This project is [MIT]( https://github.com/harshitajain06/hello-react-front-end/blob/dev/LICENSE) licensed.
